...
echo "Solr reconfigure jetty config instance[${instance_id}]"

${cmd_php} ${solr_root}/scripts/action_queue/lib/jetty.config.php ${instance_id} \
    > ${instance_root}/server/etc/solr.xml
