...
echo "Solr reconfigure solrconfig instance[${instance_id}]"

${cmd_php} ${solr_root}/scripts/action_queue/lib/solr.config.php ${instance_id} \
    > ${instance_root}/idx/conf/solrconfig.xml
